...
window.onload = function () {
  ...
  // 1. Trips by State (BAR)
  new Chart(document.getElementById('barchart'), {
    type: 'bar',
    data: {
      labels: ['Kerala', 'Tamil Nadu', 'Karnataka', 'Andhra', 'Telangana'],
      datasets: [{
  ...
  new Chart(ctxLine, {
    ...
    options: {
      plugins: {
        title: {
          display: false,
          text: 'Daily Trip Execution'
        }
      }
    }
  });

  // 3. Driver Performance (PIE)
