...
class TripResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        $data = [
            ...
            'is_initial_verified' => $this->is_initial_verified,
            'initial_verification_by' => $this->initial_verification_by,
            'initial_verification_at' => $this->formatDateTime($this->initial_verification_at),
            'is_final_verified' => $this->is_final_verified,
            'final_verification_by' => $this->final_verification_by,
            'final_verification_at' => $this->formatDateTime($this->final_verification_at),
            'notes' => $this->notes,
        ];
    ...
    private function dorDetails(): ?array
    {
        ...
        return [
            ...
            'route_start_soc_percent_image_url' => $this->storageUrl($dor->route_start_soc_percent_image),
            'route_end_soc_percent' => $dor->route_end_soc_percent,
            'route_end_soc_percent_image_url' => $this->storageUrl($dor->route_end_soc_percent_image),
    ...
    private function vehicleDetails(): ?array
    {
        ...
        return [
            ...
            'entry_ending_km' => $this->ending_km,
            'entry_starting_electric_charge' => $this->starting_electric_charge,
            'entry_ending_electric_charge' => $this->ending_electric_charge,
