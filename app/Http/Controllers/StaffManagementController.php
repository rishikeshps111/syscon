...
class StaffManagementController extends Controller implements HasMiddleware
{
    public static function middleware(): array
    {
        return [
            'auth',
            new Middleware(PermissionMiddleware::using('staff-management.view'), ['index', 'show', 'export', 'downloadPdf']),
    ...
    public function edit(User $staff_management)
    {
        ...
        return view('staff-management.form', array_merge($this->formData(), compact('record')));
    }
