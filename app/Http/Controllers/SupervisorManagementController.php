...
class SupervisorManagementController extends Controller implements HasMiddleware
{
    ...
    public function update(UpdateSupervisorManagementRequest $request, User $supervisor_management)
    {
        ...
        SalaryComponents::sync($supervisor_management, $data['salary_components'] ?? []);
    ...
    private function formData(): array
    {
        return [
            ...
            'countries' => ['India'],
            'salaryComponents' => SalaryComponents::forRole('Supervisor'),
            'salaryComponentValues' => SalaryComponents::valuesFor(request()->route('supervisor_management')),
        ];
    }
