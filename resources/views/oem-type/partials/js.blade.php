<script>
    ...
    function deleteRow(id) {
        deleteRecord('/oem-types/' + id, 'table', 'Do you really want to delete this OEM type?');
    }
</script>
