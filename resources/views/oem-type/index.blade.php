...
<x-app-layout>
    <section class="section dashboard section-top-padding">
        <div class="page-title">
            <h3>Manage OEM Type</h3>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item active">Master</li>
                    <li class="breadcrumb-item active">Manage OEM Type</li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 d-flex align-items-end">
                         ...
                         <div class="col-lg-4 btns-group-container">
                            @can('oem-types.create')
                                <button type="button" id="addNewOemType" class="add-btn form-btn">Add OEM Type</button>
                            @endcan
                            @can('oem-types.view')
