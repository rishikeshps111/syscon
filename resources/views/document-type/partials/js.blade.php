<script>
    $(function () {
        var table = $('#table').DataTable({
            ...
            columns: [
                ...
                { data: 'applies_to', name: 'applicable_for', className: 'text-center' },
        ...
        $(document).on('click', '.toggleStatus', function () {
            ...
            $.ajax({
                url: "{{ route('document-types.status') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
        ...
        $(document).on('click', '#exportSelected', function () {
            ...
            $.ajax({
                url: "{{ route('document-types.export') }}",
                type: 'POST',
                ...
                success: function (data) {
                    ...
                    a.href = url;
                    a.download = 'document-types.xlsx';
    ...
    function deleteRow(id) {
        deleteRecord('/document-types/' + id, 'table', 'Do you really want to delete this document type?');
    }
</script>
