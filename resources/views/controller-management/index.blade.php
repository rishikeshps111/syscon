...
<x-app-layout>
        ...
        <div class="page-title">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Controller Management</li>
                </ol>
            </nav>
        </div>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-lg-8">
                                    <div class="table-search">
                                        <label for="searchFilter" class="nowrap">Search (Name / Controller Code / Aadhaar /
                                            PAN)</label>
                                ...
                                <table id="table" class="align-middle mb-0 table tble-cstm mt-3" style="width:100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center nowrap">Controller Code</th>
                                            <th class="text-center nowrap">Controller Name</th>
    ...
    @section('scripts')
        @include('controller-management.partials.js')
    @endsection
</x-app-layout>
