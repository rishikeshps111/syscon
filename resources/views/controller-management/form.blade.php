@section('title')
    {{ isset($record) ? 'Edit Controller' : 'Add Controller' }}
@endsection
<x-app-layout>
    @php
        $profile = $record->controllerProfile ?? null;
        $countryCodes = [
            '+91' => '+91',
            '+1' => '+1',
            '+44' => '+44',
    ...
    <section class="section dashboard section-top-padding">
        <div class="page-title">
            <h3>{{ isset($record) ? 'Edit Controller' : 'Add Controller' }}</h3>
            <nav>
                <ol class="breadcrumb">
            ...
            <div class="col-xl-12">
                <div class="main-table-container">
                    <form class="js-loading-form" method="POST" enctype="multipart/form-data" novalidate
                        action="{{ isset($record) ? route('controller-management.update', $record->id) : route('controller-management.store') }}">
                        @csrf
                        @if(isset($record))
                            @method('PUT')
                        @endif
                            ...
                            <div class="tab-pane fade show active" id="stf1" role="tabpanel">
                                <div class="row">
                                    <div class="col-lg-4 o-f-inp mb-3">
                                        <label for="code">Controller Code <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control shadow-none" id="code"
                                            value="{{ $record->code ?? $generatedCode ?? '' }}" disabled>
                                    </div>
                                    <div class="col-lg-4 o-f-inp mb-3">
                                        <label for="name">Controller Name <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-lg-4 mb-3">
                                     ...
                                     <div class="col-lg-4 o-f-inp mb-3">
                                        <label for="avatar">Controller Image</label>
                                        <div class="d-flex align-items-center gap-3">
                                            <img id="controllerAvatarPreview" src="{{ $avatarUrl }}" alt="Controller image preview"
                        ...
                        <div class="col-lg-12 mt-3">
                            <div class="btn-flex">
                                <a href="{{ route('controller-management.index') }}" class="btn btn-secondary me-2">Cancel</a>
    ...
    @section('scripts')
        <script>
            ...
            var avatarPreview = document.getElementById('controllerAvatarPreview');
            ...
            $('#state_id').on('change', function () {
                ...
                $.ajax({
                    url: "{{ route('controller-management.districts-by-state') }}",
                    type: 'GET',
                    data: {
                        state_id: stateId
                    },
            ...
            $('#district_id').on('change', function () {
                ...
                $.ajax({
                    url: "{{ route('controller-management.locations-by-district') }}",
                    type: 'GET',
                    data: {
                        state_id: stateId,
