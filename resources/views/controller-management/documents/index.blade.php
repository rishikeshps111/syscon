...
<x-app-layout>
    ...
    <div class="controller-detail-card widget-code">
        <div class="controller-detail-icon">
            <i class="fa-solid fa-hashtag"></i>
        </div>
        <div class="controller-detail-content">
...
<div class="col-lg-3 col-md-6 mb-3">
    <div class="controller-detail-card widget-name">
        <div class="controller-detail-icon">
...
<div class="col-lg-3 col-md-6 mb-3">
    <div class="controller-detail-card widget-depot">
        <div class="controller-detail-icon">
            <i class="fa-solid fa-building"></i>
        </div>
        <div class="controller-detail-content">
            <span>Depot</span>
            <strong>{{ $controller->controllerProfile?->depot?->name ?? '-' }}</strong>
        </div>
    </div>
</div>

<div class="col-lg-3 col-md-6 mb-3">
    <div class="controller-detail-card widget-phone">
        <div class="controller-detail-icon">
            <i class="fa-solid fa-phone"></i>
        </div>
        <div class="controller-detail-content">
            <span>Phone</span>
            <strong>{{ $controller->full_phone ?: '-' }}</strong>
        </div>
    </div>
</div>
            </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('controller-management.documents.store', $controller->id) }}" method="POST"
        ...
        <script>
            $(function () {
                ...
                var table = $('#table').DataTable({
                    ...
                    searching: false,
                    ajax: {
                        url: "{{ route('controller-management.documents.index', $controller->id) }}"
                    },
                    columns: [
            ...
            function deleteDocument(id) {
                deleteRecord('/controller-documents/' + id, 'table', 'Do you really want to delete this document?');
            }
        </script>
    @endsection
</x-app-layout>
