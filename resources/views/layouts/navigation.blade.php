            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                @canany(['branch-locations.view', 'departments.view', 'levels.view', 'designations.view',
                    ...
                    <li class="nav-item">
                        ...
                        <ul id="sidebarNav6"
                            class="nav-content collapse sub-menu {{ request()->routeIs('branch-locations.*', 'departments.*', 'levels.*', 'designations.*', 'role-permissions.*', 'hrms-document-types.*', 'leave-types.*', 'shift-settings.*', 'leaves.*', 'attendance-management.*', 'holidays.*', 'staff-management.*', 'controller-management.*', 'supervisor-management.*', 'driver-management.*') ? 'show' : '' }}"
                            data-bs-parent="#sidebar-nav">
