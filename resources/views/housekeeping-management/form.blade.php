@section('title')
    {{ isset($record) ? 'Edit Housekeeping User' : 'Add Housekeeping User' }}
@endsection
<x-app-layout>
    @php
        $profile = $record->housekeepingProfile ?? null;
        $countryCodes = [
            '+91' => '+91',
            '+1' => '+1',
            '+44' => '+44',
    ...
    <section class="section dashboard section-top-padding">
        <div class="page-title">
            <h3>{{ isset($record) ? 'Edit Housekeeping User' : 'Add Housekeeping User' }}</h3>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item active">HRMS</li>
                    <li class="breadcrumb-item"><a href="{{ route('housekeeping-management.index') }}">Housekeeping Management</a>
                    </li>
            ...
            <div class="col-xl-12">
                <div class="main-table-container">
                    <form class="js-loading-form" method="POST" enctype="multipart/form-data" novalidate
                        action="{{ isset($record) ? route('housekeeping-management.update', $record->id) : route('housekeeping-management.store') }}">
                        @csrf
                        @if (isset($record))
                            @method('PUT')
                        @endif
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered justify-content-start" role="tablist">
                            @foreach ([
        'hsk1' => 'Basic Information',
        'hsk2' => 'Identity Details',
        'hsk4' => 'Employment Details',
        'hsk5' => 'Bank Details',
        'hsk6' => 'Emergency & Medical',
        'hsk7' => 'Status & Verification',
        'hsk8' => 'Salary Structure',
    ] as $target => $label)
                        ...
                        <div class="tab-content pt-2">
                            <div class="tab-pane fade show active" id="hsk1" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 o-f-inp mb-3">
                                        <label for="avatar">Housekeeping Image</label>
                                        <div class="d-flex align-items-center gap-3">
                                            <img id="housekeepingAvatarPreview" src="{{ $avatarUrl }}"
                                                alt="Housekeeping image preview" width="70" height="70"
                            ...
                            </div><div class="tab-pane fade" id="hsk4" role="tabpanel">
                                <div class="row">
                            ...
                            <div class="tab-pane fade" id="hsk5" role="tabpanel">
                                <div class="row">
                                    <div class="col-lg-6 o-f-inp mb-3">
                            ...
                            <div class="tab-pane fade" id="hsk6" role="tabpanel">
                                <div class="row">
                                    <div class="col-lg-4 o-f-inp mb-3">
                            ...
                            <div class="tab-pane fade" id="hsk7" role="tabpanel">
                                <div class="row">
                                    <div class="col-lg-4 o-f-inp mb-3">
                            ...
                            <div class="tab-pane fade" id="hsk8" role="tabpanel">
                        ...
                        <div class="col-lg-12 mt-3">
                            <div class="btn-flex">
                                <a href="{{ route('housekeeping-management.index') }}"
    ...
    @section('scripts')
        <script>
            ...
            var wizardTabs = Array.from(document.querySelectorAll('[data-bs-toggle="tab"][data-bs-target^="#hsk"]'));
            ...
            var avatarPreview = document.getElementById('housekeepingAvatarPreview');
            ...
            $('#state_id').on('change', function() {
                ...
                $.ajax({
                    url: "{{ route('housekeeping-management.districts-by-state') }}",
                    type: 'GET',
                    data: {
                        state_id: stateId
                    },
            ...
            $('#district_id').on('change', function() {
                ...
                $.ajax({
                    url: "{{ route('housekeeping-management.locations-by-district') }}",
                    type: 'GET',
                    data: {
                        state_id: stateId,
