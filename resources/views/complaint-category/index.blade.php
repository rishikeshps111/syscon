...
<x-app-layout>
    <section class="section dashboard section-top-padding">
        <div class="page-title">
            <h3>Manage Complaint Category</h3>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item active">Masters</li>
                    <li class="breadcrumb-item active">Manage Complaint Category</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="main-table-container">
                    ...
                    <div class="row">
                        <div class="col-lg-5 ms-auto justify-content-end d-flex">
                            @can('complaint-categories.create')
                                <button type="button" id="addNewComplaintCategory" class="add-btn form-btn">Add Complaint Category</button>
                            @endcan
    ...
    @section('scripts')
        @include('complaint-category.partials.js')
    @endsection
</x-app-layout>
