<script>
    $(function () {
        var table = $('#table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('complaint-categories.index') }}",
                data: function (data) {
        ...
        $(document).on('click', '.form-btn', function () {
            var id = $(this).data('id');
            $.ajax({
                url: "{{ route('complaint-categories.create') }}",
                type: 'GET',
                data: { id: id },
        ...
        $(document).on('click', '.toggleStatus', function () {
            ...
            $.ajax({
                url: "{{ route('complaint-categories.status') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
        ...
        $(document).on('click', '#exportSelected', function () {
            ...
            $.ajax({
                url: "{{ route('complaint-categories.export') }}",
                type: 'POST',
                ...
                success: function (data) {
                    ...
                    a.href = url;
                    a.download = 'complaint-categories.xlsx';
    ...
    function deleteRow(id) {
        deleteRecord('/complaint-categories/' + id, 'table', 'Do you really want to delete this complaint category?');
    }
</script>
