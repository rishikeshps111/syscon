<script>
    $(function () {
        var table = $('#table').DataTable({
            ...
            columns: [
                ...
                { data: 'default', name: 'is_default', orderable: false, searchable: false, className: 'text-center' },
        ...
        $('#stateFilter, #statusFilter').on('change', function () {
    ...
    function deleteRow(id) {
        deleteRecord('/districts/' + id, 'table', 'Do you really want to delete this district?');
    }
