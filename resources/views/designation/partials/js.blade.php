<script>
    $(function () {
        var table = $('#table').DataTable({
            ...
            ajax: {
                ...
                data: function (data) {
                    data.department_id = $('#departmentFilter').val();
                    data.level_id = $('#levelFilter').val();
        ...
        $('#departmentFilter, #levelFilter, #statusFilter').on('change', function () {
    ...
    function deleteRow(id) {
        deleteRecord('/designations/' + id, 'table', 'Do you really want to delete this designation?');
    }

    function initDesignationSelect() {
