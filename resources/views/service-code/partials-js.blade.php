<script>
    $(function () {
        ...
        $(document).on('click', '.form-btn', function () {
            var id = $(this).data('id');
            $.ajax({
                url: "{{ route('service-codes.create') }}",
                type: 'GET',
                data: { id: id },
        ...
        $(document).on('click', '.toggleStatus', function () {
            ...
            $.ajax({
                url: "{{ route('service-codes.status') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
        ...
        /* Service code export is intentionally not enabled yet. */
    ...
    function deleteRow(id) {
        deleteRecord('/service-codes/' + id, 'table', 'Do you really want to delete this service code?');
    }
</script>
