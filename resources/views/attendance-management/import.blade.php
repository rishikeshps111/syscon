                ...
                <div class="main-table-container h-100">
                    <form class="js-loading-form" method="POST" action="{{ route('attendance-management.import') }}" enctype="multipart/form-data">
                        ...
                        <div class="o-f-inp file-input mb-3">
                            <label for="csvFile">Excel File <span class="text-danger">*</span></label>
                            <input type="file" id="csvFile" name="csv_file" class="form-control shadow-none" accept=".xlsx,.xls,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel" required>
                            @error('csv_file')
            ...
            <div class="col-lg-7 mb-3">
                <div class="main-table-container h-100">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3 btns-group-container" style="justify-content:space-between !important;">
                        <h5 class="mb-0">Excel Instructions</h5>
                        <a href="{{ route('attendance-management.sample-csv') }}" class="exp-btn">Download Sample Excel</a>
                    </div>

                    <p class="mb-2">Use the exact header row in the Excel file:</p>
