...
<x-app-layout>
                ...
                <div class="main-table-container">
                    ...
                    <div class="row">
                        <div class="col-lg-4 ms-auto justify-content-end d-flex">
                            @can('routes.edit')
                                <button type="button" id="addNewRouteSchedule" class="add-btn form-btn">Add Schedule</button>
                            @endcan
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <table id="table" class="table align-middle mb-0 table tble-cstm mt-3" style="width:100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Planned Start</th>
    ...
    @section('scripts')
        @include('route-schedule.partials.js')
    @endsection
</x-app-layout>
