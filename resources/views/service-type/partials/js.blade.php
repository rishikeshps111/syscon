<script>
    $(function () {
        ...
        $(document).on('click', '.toggleStatus', function () {
            ...
            $.ajax({
                url: "{{ route('service-types.status') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
        ...
        $(document).on('click', '#exportSelected', function () {
            ...
            $.ajax({
                url: "{{ route('service-types.export') }}",
                type: 'POST',
    ...
    function deleteRow(id) {
        deleteRecord('/service-types/' + id, 'table', 'Do you really want to delete this service type?');
    }
</script>
