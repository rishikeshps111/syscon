<script>
    $(function () {
        var table = $('#table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('dor-account-responsibles.index') }}",
                data: function (data) {
        ...
        $(document).on('click', '.form-btn', function () {
            $.get("{{ route('dor-account-responsibles.create') }}", { id: $(this).data('id') })
        ...
        $(document).on('click', '.toggleStatus', function () {
            $.post("{{ route('dor-account-responsibles.status') }}", {
                _token: "{{ csrf_token() }}",
                id: $(this).data('id'),
        ...
        $('#exportSelected').on('click', function () {
            ...
            $.ajax({
                url: "{{ route('dor-account-responsibles.export') }}",
                type: 'POST',
                ...
                success: function (data) {
                    ...
                    a.download = 'dor-account-responsibles.xlsx';
    ...
    function deleteRow(id) {
        deleteRecord('/dor-account-responsibles/' + id, 'table', 'Do you really want to delete this account responsible?');
    }
</script>
