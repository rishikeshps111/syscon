...
<x-app-layout>
    <section class="section dashboard section-top-padding">
        <div class="page-title">
            <h3>Manage Account Responsible</h3>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item active">Masters</li>
                    <li class="breadcrumb-item active">Manage Account Responsible</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 d-flex align-items-end">
                 ...
                 <div class="col-lg-5 ms-auto btns-group-container">
                    @can('dor-account-responsibles.create')
                        <button type="button" class="add-btn form-btn">Add Account Responsible</button>
                    @endcan
    ...
    @section('scripts')
        @include('dor-account-responsible.partials.js')
    @endsection
</x-app-layout>
