        ...
        <div class="main-table-container mb-3">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="supervisor-detail-card">
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="supervisor-detail-card">
                        <span>Depot</span>
                        <strong>{{ $supervisor->supervisorProfile?->depot?->name ?? '-' }}</strong>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="supervisor-detail-card">
                        <span>Phone</span>
                        <strong>{{ $supervisor->full_phone ?: '-' }}</strong>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('supervisor-management.documents.store', $supervisor->id) }}" method="POST"
        ...
        <div class="main-table-container">
            <div class="row mb-3">
                <div class="col-lg-12 d-flex justify-content-end align-items-end">
                    <div class="btn-flex">
                        <a href="{{ route('supervisor-management.index') }}" class="add-btn bg-filter">Back</a>
                        @can('supervisor-management.edit')
        ...
        <script>
            $(function () {
                ...
                var table = $('#table').DataTable({
                    ...
                    searching: false,
                    ajax: {
                        url: "{{ route('supervisor-management.documents.index', $supervisor->id) }}"
                    },
                    columns: [
            ...
            function deleteDocument(id) {
                deleteRecord('/supervisor-documents/' + id, 'table', 'Do you really want to delete this document?');
            }
        </script>
    @endsection
</x-app-layout>
