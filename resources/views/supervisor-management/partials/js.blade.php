<script>
    $(function () {
        ...
        var table = $('#table').DataTable({
            ...
            searching: false,
            ajax: {
                url: "{{ route('supervisor-management.index') }}",
                data: filters
            },
            columns: [
                {
                ...
                { data: 'depot', name: 'supervisorProfile.depot.name', orderable: false, searchable: false, className: 'text-center' },
                { data: 'employment_type', name: 'supervisorProfile.employment_type', orderable: false, searchable: false, className: 'text-center' },
                { data: 'location', name: 'supervisorProfile.location.name', orderable: false, searchable: false, className: 'text-center' },
                { data: 'date_of_joining', name: 'supervisorProfile.date_of_joining', orderable: false, searchable: false, className: 'text-center' },
                { data: 'gross_salary', name: 'supervisorProfile.gross_salary', orderable: false, searchable: false, className: 'text-center' },
        ...
        $(document).on('click', '.toggleStatus', function () {
            ...
            $.ajax({
                url: "{{ route('supervisor-management.status') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    id: id,
        ...
        $(document).on('click', '#exportSelected', function () {
            ...
            $.ajax({
                url: "{{ route('supervisor-management.export') }}",
                type: 'POST',
                ...
                success: function (data) {
                    ...
                    a.href = url;
                    a.download = 'supervisor-management.xlsx';
