                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-3">
                            <div class="btn-flex justify-content-end">
                                <a href="{{ route('driver-management.index') }}" class="btn btn-secondary">Back</a>
                                <a href="{{ route('driver-management.download-pdf', $record->id) }}" class="btn btn-primary">Download PDF</a>
                            </div>
                        </div>
