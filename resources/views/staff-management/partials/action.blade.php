@canany(['staff-management.view', 'staff-management.edit', 'staff-management.delete'])
    <div class="action-btns">
        @can('staff-management.edit')
            ...
            <a href="{{ route('staff-management.edit', $row->id) }}" class="btn-edit" title="Edit">
        ...
        @can('staff-management.view')
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dromenu-cs">
                    <li><a class="dropdown-item" href="{{ route('staff-management.show', $row->id) }}">View Details</a></li>
                    <li><a class="dropdown-item" href="{{ route('staff-management.documents.index', $row->id) }}">Documents</a>
                    </li>
