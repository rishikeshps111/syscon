                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('staff-management.documents.store', $staff->id) }}" method="POST"
        ...
        <script>
            $(function () {
                ...
                var table = $('#table').DataTable({
                    ...
                    searching: false,
                    ajax: {
                        url: "{{ route('staff-management.documents.index', $staff->id) }}"
                    },
                    columns: [
            ...
            function deleteDocument(id) {
                deleteRecord('/staff-documents/' + id, 'table', 'Do you really want to delete this document?');
            }
        </script>
    @endsection
</x-app-layout>
