<script>
    $(function () {
        var table = $('#table').DataTable({
            ...
            columns: [
                ...
                { data: 'service_type_name', name: 'serviceType.name', className: 'text-center' },
                { data: 'route_name', name: 'route.name', className: 'text-center' },
    ...
    function deleteRow(id) {
        deleteRecord('/trip-setups/' + id, 'table', 'Do you really want to delete this trip setup?');
    }

    function initTripSetupSelect() {
